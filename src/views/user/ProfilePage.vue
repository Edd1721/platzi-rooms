          ...
          <aside class="profile__aside px-3">
            <div class="profile__card">
              <div class="profile__thumbnail">
                <img class="profile__image w-full" :src="user.avatar">
              </div>
            </div>
          </aside>
          <div class="profile__fields">
            <form class="form">
              <div class="mb-4">
                ...
                <div class="form__field relative">
                  <input v-model="user.name" class="input__field" id="name" type="text" placeholder="Bruce Wayne">
                </div>
              </div>
              <div class="mb-4">
                <label class="input__label" for="username">Username</label>
                <div class="form__field relative">
                  <input v-model="user.username" class="input__field" id="username" type="text" placeholder="bruce.wayne">
                </div>
              </div>
              <div class="mb-4">
                <label
                ...
                <div class="form__field relative">
                  <input v-model="user.avatar" class="input__field" id="avatar" type="text" placeholder="https://avatars1.githubusercontent.com/u/9919?s=500&v=4">
                </div>
              </div>
              <div class="mb-4">
                <label
